...
export const periodCareTips = [
    ...
    },
    {
        icon: Heater,
        title: "Gentle Warmth",
        text: "A warm compress or a hot water bottle on your lower abdomen can work wonders for easing muscle tension.",
    ...
    },
    {
        icon: Droplets,
        title: "Stay Hydrated",
        text: "Drinking plenty of water can help reduce bloating and ease some of the discomfort.",
        color: 'text-blue-500',
    },
];
